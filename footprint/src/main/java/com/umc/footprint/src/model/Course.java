...
public class Course extends BaseEntity {
    ...
    @Builder
    public Course(Integer courseIdx, String courseName, String courseImg, Point startCoordinate, String coordinate, String address, double length, Integer courseTime, Integer walkIdx, String description, Integer markNum, Integer likeNum, String status) {
